...
if(!isset($arSort['nearest_activity']))
{
	...
	if($arParams["TIMFORS_COMPANY"])
        $arFilter["COMPANY_ID"]=$arParams["TIMFORS_COMPANY"];

	if(count($arParams["TIMFORS_COMPANY_USER"])>0)
        $arFilter["ASSIGNED_BY_ID"]=$arParams["TIMFORS_COMPANY_USER"];
