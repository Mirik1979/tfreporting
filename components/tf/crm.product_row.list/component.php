...
$arResult['ROLE_PROJECT']=$RoleProject->getList();
$arResult['YEARS_EXPERIENCE']=$YearsExperience->getList();
$arResult['PRODUCT']=$Product->getList();
$arResult['PREFERRED_LOCATION']=$PreferredLocation->getList();
$arResult['GRADE']=$Grade->getList();

//print_r($arResult['ROLE_PROJECT']);
