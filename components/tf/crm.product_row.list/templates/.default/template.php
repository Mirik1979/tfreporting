...
use local\Services\ResourcePlan\Model;
...
?>  <div class="crm-items-table-top-bar">
        ...
        <span <?= ($arResult['INVOICE_MODE']) ? ' style="display: none;"' : '' ?>>
            <input type="file" id="import_from_excel_file">
            <span id="import_from_excel" class="webform-small-button" data-groupid="<?=$arParams["GroupId"];?>" data-ownerid="<?=$arParams["OWNER_ID"];?>">
                <span class="webform-small-button-left"></span>
                <span class="webform-small-button-text">Импорт из Excel</span>
...
?>
	<table id="<?= $productContainerID ?>" class="crm-items-table" style="<?= $nProductRows === 0 ? 'display: none;' : '' ?>">
		...
		$productEditorCfg = array(
			...
			'serviceUrl'=> '/local/components/tf/crm.product_row.list/ajax.php?'.bitrix_sessid_get(),
		...
		for ($i = 0; $i < $nProductRows; $i++)
		{
			...
			<tr id="<?=$rowID?>" class="<?=$className?>">
                ...
                <td class="crm-item-cell crm-item-role-project">
					<?/*<span class="crm-item-cell-text"<?= $bInitEditable ? '' : ' style="display: none;"' ?>>
						<input id="<?=$rowID.'_ROLE_PROJECT'?>" type="text" class="crm-item-table-inp" value="<?//=$htmlValues['PRICE']?>"/>
					</span>*/?>
                    <span class="crm-item-cell-text"<?= $bInitEditable ? '' : ' style="display: none;"' ?>>
						<select id="<?=$rowID.'_ROLE_PROJECT'?>" class="crm-item-table-select">
                            <option value=""></option>
							<?php
                            foreach ($arResult['ROLE_PROJECT'] as $val)
                            {
                                echo '<option value="'.$val["ID"].'"'.
                                    ($val["ID"] === $ResrequestsProductArray->getRoleProject() ? ' selected="selected"' : '').
                                    '>'.
                                    $val["NAME"].'</option>'.PHP_EOL;
                            }
                            ?>
						</select>
					</span>
                    <span class="crm-item-cell-view"<?= $bInitEditable ? ' style="display: none;"' : '' ?>>
						<div id="<?=$rowID.'_ROLE_PROJECT_v'?>" class="crm-item-table-txt">
                             <?foreach ($arResult['ROLE_PROJECT'] as $val)
                            {
                                    if($val["ID"] === $ResrequestsProductArray->getRoleProject())
                                        echo $val["NAME"];
                ...
                <td class="crm-item-cell crm-item-role-project">
                    <span class="crm-item-cell-text"<?= $bInitEditable ? '' : ' style="display: none;"' ?>>
						<select id="<?=$rowID.'_PRODUCT'?>" class="crm-item-table-select">
                            <option value=""></option>
                            <?php
                            foreach ($arResult['PRODUCT'] as $val)
                            {
                                echo '<option value="'.$val["ID"].'"'.
                                    ($val["ID"] === $ResrequestsProductArray->getProduct() ? ' selected="selected"' : '').
                                    '>'.
                                    $val["NAME"].'</option>'.PHP_EOL;
                            }
                            ?>
                    ...
                    <span class="crm-item-cell-view"<?= $bInitEditable ? ' style="display: none;"' : '' ?>>
						<div id="<?=$rowID.'_PRODUCT_v'?>" class="crm-item-table-txt"><?foreach ($arResult['PRODUCT'] as $val)
                            {
                                if($val["ID"] === $ResrequestsProductArray->getProduct())
                                    echo $val["NAME"];
                            }?></div>
					</span>
                </td>
                ...
                <?
                $arrModel=[];
                if($ResrequestsProductArray->getProduct()>0){

                    $arrModel=$Model->getList($ResrequestsProductArray->getProduct());
                ...
                <td class="crm-item-cell crm-item-role-project">
                    <span class="crm-item-cell-text"<?= $bInitEditable ? '' : ' style="display: none;"' ?>>
						<select id="<?=$rowID.'_MODEL'?>" class="crm-item-table-select">
                            <option value="">Выберите продукт</option>
                            <?php
                            foreach ($arrModel as $val)
                            {
                                echo '<option value="'.$val["ID"].'"'.
                                    ($val["ID"] === $ResrequestsProductArray->getModel() ? ' selected="selected"' : '').
                                    '>'.
                                    $val["NAME"].'</option>'.PHP_EOL;
                            }
                            ?>
                    ...
                    <span class="crm-item-cell-view"<?= $bInitEditable ? ' style="display: none;"' : '' ?>>
						<div id="<?=$rowID.'_MODEL_v'?>" class="crm-item-table-txt"><?foreach ($arrModel as $val)
                            {
                                if($val["ID"] === $ResrequestsProductArray->getModel())
                                    echo $val["NAME"];
                            }?></div>
					</span>
                </td>
                ...
                <td class="crm-item-cell crm-item-role-project">
                    <span class="crm-item-cell-text"<?= $bInitEditable ? '' : ' style="display: none;"' ?>>
						<select id="<?=$rowID.'_GRADE'?>" class="crm-item-table-select">
                            <option value=""></option>
                            <?php
                            foreach ($arResult['GRADE'] as $val)
                            {
                                echo '<option value="'.$val["ID"].'"'.
                                    ($val["ID"] === $ResrequestsProductArray->getGrade() ? ' selected="selected"' : '').
                                    '>'.
                                    $val["NAME"].'</option>'.PHP_EOL;
                            }
                            ?>
                    ...
                    <span class="crm-item-cell-view"<?= $bInitEditable ? ' style="display: none;"' : '' ?>>
						<div id="<?=$rowID.'_GRADE_v'?>" class="crm-item-table-txt"><?foreach ($arResult['GRADE'] as $val)
                            {
                                if($val["ID"] === $ResrequestsProductArray->getGrade())
                                    echo $val["NAME"];
                            }?></div>
					</span>
                </td>
                ...
                <td class="crm-item-cell crm-item-role-project">
                    <span class="crm-item-cell-text"<?= $bInitEditable ? '' : ' style="display: none;"' ?>>
						<select id="<?=$rowID.'_YEARS_EXPERIENCE'?>" class="crm-item-table-select">
                            <option value=""></option>
                            <?php
                            foreach ($arResult['YEARS_EXPERIENCE'] as $val)
                            {
                                echo '<option value="'.$val["ID"].'"'.
                                    ($val["ID"] === $ResrequestsProductArray->getYearsExperience() ? ' selected="selected"' : '').
                                    '>'.
                                    $val["NAME"].'</option>'.PHP_EOL;
                            }
                            ?>
                    ...
                    <span class="crm-item-cell-view"<?= $bInitEditable ? ' style="display: none;"' : '' ?>>
						<div id="<?=$rowID.'_YEARS_EXPERIENCE_v'?>" class="crm-item-table-txt"><?foreach ($arResult['YEARS_EXPERIENCE'] as $val)
                            {
                                if($val["ID"] === $ResrequestsProductArray->getYearsExperience())
                                    echo $val["NAME"];
                            }?></div>
					</span>
                </td>
                ...
                <td class="crm-item-cell crm-item-role-project">
                    <span class="crm-item-cell-text"<?= $bInitEditable ? '' : ' style="display: none;"' ?>>
						<select id="<?=$rowID.'_PREFERRED_LOCATION'?>" class="crm-item-table-select">
                            <option value=""></option>
                            <?php
                            foreach ($arResult['PREFERRED_LOCATION'] as $val)
                            {
                                echo '<option value="'.$val["ID"].'"'.
                                    ($val["ID"] === $ResrequestsProductArray->getPreferredLocatio() ? ' selected="selected"' : '').
                                    '>'.
                                    $val["NAME"].'</option>'.PHP_EOL;
                            }
                            ?>
                    ...
                    <span class="crm-item-cell-view"<?= $bInitEditable ? ' style="display: none;"' : '' ?>>
						<div id="<?=$rowID.'_PREFERRED_LOCATION_v'?>" class="crm-item-table-txt"><?foreach ($arResult['PREFERRED_LOCATION'] as $val)
                            {
                                if($val["ID"] === $ResrequestsProductArray->getPreferredLocatio())
                                    echo $val["NAME"];
                            }?></div>
					</span>
                </td>
                ...
                <td class="crm-item-cell crm-item-price">
					<span class="crm-item-cell-text"<?= $bInitEditable ? '' : ' style="display: none;"' ?>>
						<input id="<?=$rowID.'_AMOUNT_OVERHEAD'?>" type="text" class="crm-item-table-inp" value="<?=$ResrequestsProductArray->getAmountOverhead()?>"/>
					</span>
                    <span class="crm-item-cell-view"<?= $bInitEditable ? ' style="display: none;"' : '' ?>>
						<div id="<?=$rowID.'_AMOUNT_OVERHEAD_v'?>" class="crm-item-table-txt"><?=$ResrequestsProductArray->getAmountOverhead()?></div>
					</span>
                </td>
                <?
                if($ResrequestsProductArray->getStartWork())
                    $StartWork=$ResrequestsProductArray->getStartWork()->format('d.m.Y H:i:s');
                else
                    $StartWork="";
                ?>
                <td class="crm-item-cell crm-item-price">
					<span class="crm-item-cell-text"<?= $bInitEditable ? '' : ' style="display: none;"' ?>>
						<input onclick="BX.calendar({callback_after:function(param){this.params.field.dispatchEvent(new Event('change'));},bHideTime:false,node: this, field: this, bTime: true});" id="<?=$rowID.'_START_WORK'?>" type="text" class="crm-item-table-inp" value="<?=$StartWork?>"/>
					</span>
                    <span class="crm-item-cell-view"<?= $bInitEditable ? ' style="display: none;"' : '' ?>>
						<div id="<?=$rowID.'_START_WORK_v'?>" class="crm-item-table-txt"><?=$StartWork?></div>
					</span>
                </td>
                <?
                if($ResrequestsProductArray->getEndWork())
                    $EndWork=$ResrequestsProductArray->getEndWork()->format('d.m.Y H:i:s');
                else
                    $EndWork="";
                ?>
                <td class="crm-item-cell crm-item-price">
					<span class="crm-item-cell-text"<?= $bInitEditable ? '' : ' style="display: none;"' ?>>
						<input onclick="BX.calendar({callback_after:function(param){this.params.field.dispatchEvent(new Event('change'));},bHideTime:false,node: this, field: this, bTime: true});" id="<?=$rowID.'_END_WORK'?>" type="text" class="crm-item-table-inp" value="<?=$EndWork?>"/>
					</span>
                    <span class="crm-item-cell-view"<?= $bInitEditable ? ' style="display: none;"' : '' ?>>
						<div id="<?=$rowID.'_END_WORK_v'?>" class="crm-item-table-txt"><?=$EndWork?></div>
					</span>
                </td>
				...
				<td class="crm-item-cell crm-item-qua">
					<span class="crm-item-cell-text"<?= $bInitEditable ? '' : ' style="display: none;"' ?>>
						<input disabled id="<?=$rowID.'_QUANTITY'?>" type="text" class="crm-item-table-inp" value="<?=$htmlValues['QUANTITY']?>"/>
					</span>
					<span class="crm-item-cell-view"<?= $bInitEditable ? ' style="display: none;"' : '' ?>>
	...
	<table style="display: none;">
		...
		<tr id="<?= ($rowIdPrefix.'#N#') ?>" style="display: none;">
            ...
            <td class="crm-item-cell crm-item-role-project">
                <span class="crm-item-cell-text"<?= $bInitEditable ? '' : ' style="display: none;"' ?>>
						<select id="<?= ($rowIdPrefix.'#N#_ROLE_PROJECT') ?>" class="crm-item-table-select">
                            <option value=""></option>
                            <?php
                            foreach ($arResult['ROLE_PROJECT'] as $val)
                            {
                ...
                <span class="crm-item-cell-view"<?= $bInitEditable ? ' style="display: none;"' : '' ?>>
						<div id="<?= ($rowIdPrefix.'#N#_ROLE_PROJECT_v') ?>" class="crm-item-table-txt"></div>
					</span>
            </td>
            ...
            <td class="crm-item-cell crm-item-role-project">
                    <span class="crm-item-cell-text"<?= $bInitEditable ? '' : ' style="display: none;"' ?>>
						<select id="<?= ($rowIdPrefix.'#N#_PRODUCT') ?>" class="crm-item-table-select">
                            <option value=""></option>
                            <?php
                            foreach ($arResult['PRODUCT'] as $val)
                            {
                ...
                <span class="crm-item-cell-view"<?= $bInitEditable ? ' style="display: none;"' : '' ?>>
						<div id="<?= ($rowIdPrefix.'#N#_PRODUCT_v') ?>" class="crm-item-table-txt"><?//=$htmlValues['PRICE']?></div>
					</span>
            </td>
            ...
            <td class="crm-item-cell crm-item-role-project">
                    <span class="crm-item-cell-text"<?= $bInitEditable ? '' : ' style="display: none;"' ?>>
						<select id="<?= ($rowIdPrefix.'#N#_MODEL') ?>" class="crm-item-table-select">
                            <option value="">Выберите продукт</option>
						</select>
					</span>
                <span class="crm-item-cell-view"<?= $bInitEditable ? ' style="display: none;"' : '' ?>>
						<div id="<?= ($rowIdPrefix.'#N#_MODEL_v') ?>" class="crm-item-table-txt"><?//=$htmlValues['PRICE']?></div>
					</span>
            </td>
            ...
            <td class="crm-item-cell crm-item-role-project">
                    <span class="crm-item-cell-text"<?= $bInitEditable ? '' : ' style="display: none;"' ?>>
						<select id="<?= ($rowIdPrefix.'#N#_GRADE') ?>" class="crm-item-table-select">
                            <option value=""></option>
                            <?php
                            foreach ($arResult['GRADE'] as $val)
                            {
                ...
                <span class="crm-item-cell-view"<?= $bInitEditable ? ' style="display: none;"' : '' ?>>
						<div id="<?= ($rowIdPrefix.'#N#_GRADE_v') ?>" class="crm-item-table-txt"><?//=$htmlValues['PRICE']?></div>
					</span>
            </td>
            ...
            <td class="crm-item-cell crm-item-role-project">
                    <span class="crm-item-cell-text"<?= $bInitEditable ? '' : ' style="display: none;"' ?>>
						<select id="<?= ($rowIdPrefix.'#N#_YEARS_EXPERIENCE') ?>" class="crm-item-table-select">
                            <option value=""></option>
                            <?php
                            foreach ($arResult['YEARS_EXPERIENCE'] as $val)
                            {
                ...
                <span class="crm-item-cell-view"<?= $bInitEditable ? ' style="display: none;"' : '' ?>>
						<div id="<?= ($rowIdPrefix.'#N#_YEARS_EXPERIENCE_v') ?>" class="crm-item-table-txt"><?//=$htmlValues['PRICE']?></div>
					</span>
            </td>

            <td class="crm-item-cell crm-item-role-project">
                    <span class="crm-item-cell-text"<?= $bInitEditable ? '' : ' style="display: none;"' ?>>
						<select id="<?= ($rowIdPrefix.'#N#_PREFERRED_LOCATION') ?>" class="crm-item-table-select">
                            <option value=""></option>
                            <?php
                            foreach ($arResult['PREFERRED_LOCATION'] as $val)
                            {
                ...
                <span class="crm-item-cell-view"<?= $bInitEditable ? ' style="display: none;"' : '' ?>>
						<div id="<?= ($rowIdPrefix.'#N#_PREFERRED_LOCATION_v') ?>" class="crm-item-table-txt"><?//=$htmlValues['PRICE']?></div>
					</span>
            </td>
            ...
            <td class="crm-item-cell crm-item-price">
					<span class="crm-item-cell-text"<?= $bInitEditable ? '' : ' style="display: none;"' ?>>
						<input id="<?= ($rowIdPrefix.'#N#_AMOUNT_OVERHEAD') ?>" type="text" class="crm-item-table-inp" value="0.00"/>
					</span>
                <span class="crm-item-cell-view"<?= $bInitEditable ? ' style="display: none;"' : '' ?>>
						<div id="<?= ($rowIdPrefix.'#N#_AMOUNT_OVERHEAD_v') ?>" class="crm-item-table-txt">0.00</div>
					</span>
            </td>
            <td class="crm-item-cell crm-item-price">
					<span class="crm-item-cell-text"<?= $bInitEditable ? '' : ' style="display: none;"' ?>>
						<input onclick="BX.calendar({callback_after:function(param){this.params.field.dispatchEvent(new Event('change'));},bHideTime:false,node: this, field: this, bTime: true});" id="<?= ($rowIdPrefix.'#N#_START_WORK') ?>" type="text" class="crm-item-table-inp" value=""/>
					</span>
                <span class="crm-item-cell-view"<?= $bInitEditable ? ' style="display: none;"' : '' ?>>
						<div id="<?= ($rowIdPrefix.'#N#_START_WORK_v') ?>" class="crm-item-table-txt"></div>
					</span>
            </td>
            <td class="crm-item-cell crm-item-price">
					<span class="crm-item-cell-text"<?= $bInitEditable ? '' : ' style="display: none;"' ?>>
						<input onclick="BX.calendar({callback_after:function(param){this.params.field.dispatchEvent(new Event('change'));},bHideTime:false,node: this, field: this, bTime: true});" id="<?= ($rowIdPrefix.'#N#_END_WORK') ?>" type="text" class="crm-item-table-inp" value=""/>
					</span>
                <span class="crm-item-cell-view"<?= $bInitEditable ? ' style="display: none;"' : '' ?>>
						<div id="<?= ($rowIdPrefix.'#N#_END_WORK_v') ?>" class="crm-item-table-txt"></div>
					</span>
            </td>
			...
			<td class="crm-item-cell crm-item-qua">
					<span class="crm-item-cell-text">
						<input disabled id="<?= ($rowIdPrefix.'#N#_QUANTITY') ?>" type="text" class="crm-item-table-inp" value="0"/>
					</span>
					<span class="crm-item-cell-view">
